...
2. In Xcode’s toolbar, where you can select which scheme to build, select “AvaTax-Calc-SDK.”  It will have an icon that looks like a white library building.  Choose “iOS Device”.
...
6. Lastly, you’ll need to update your “Header Search Paths” build setting for the affected targets.  Add a header search path that points to the directory in the SDK with all the .h files in it.  The exact text you want to add is probably this relative path: “AvaTaxSDK/include/AvaTax-Calc-SDK”
